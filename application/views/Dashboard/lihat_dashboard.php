			...
			<div class="box box-widget widget-user">
				<div class="widget-user-header bg-black-active">
					<p style="text-align: center;">
						<span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di Zenith Comp</span>
					</p>
					<h3 class="widget-user-username"></h3>
					<h5 class="widget-user-desc"></h5>
				</div>
				<div class="widget-user-image">
					<img class="img-circle" src="<?php echo base_url(); ?>assets/dist/img/computer logo.jpg">
				</div>
				<div class="box-footer">
					<div class="row">
						...
						<div class="col-sm-4 border-right">
							<div class="description-block">
								<h5 class="description-header">Kantor: Jl. Paus Ujung No 88q ,Kec.Tangkerang Tengah, Kab.Pekanbaru, Kec. Riau</h5>
								<span class="description-text">No.Telp: 0823-8985-2694</span>
							</div>
							<center>
								<i>Sistem Stok dan Penjualan Barang-barang Toko Komputer</i><br>
							</center>
						</div>
						<div class="col-sm-3">
							<div class="description-block">
